...
async def handle_about(message: Message) -> None:
    ...
    await message.answer(
        ...
        "бизнес-процессов, сбора заявок, взаимодействия "
        "с клиентами и интеграции внешних сервисов.\n\n"
        "В работе уделяю внимание структуре проекта, "
        "безопасности данных и возможности дальнейшего "
        "развития продукта."
    )
...
async def handle_portfolio(message: Message) -> None:
    ...
    await message.answer(
        ...
        "Здесь будут размещены описания проектов, "
        "используемые технологии и результаты автоматизации."
    )
